// @perch/runtime — Request/Response types and body parsing helpers.
//
// These match the JSON wire protocol in perch-host-abi. perch-worker
...
// function. The handler deserializes it into a PerchRequest, does its
// work, and returns a serialized PerchResponse.
//
// This module wraps that JSON-over-string protocol with a clean API so
// deployment authors write:
//
//   import { PerchRequest, PerchResponse, respond } from "@perch/runtime";
//
