...
// canonical Perch deployment shape.
//
// Each Perch deployment is a Perry plugin compiled with --output-type dylib.
// perch-worker is a Rust process that links perry-runtime, dlopens the
