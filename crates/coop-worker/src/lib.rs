//! In-process host for Perry-compiled Coop application libraries.
//!
//! Both the standalone compatibility worker and the main Coop daemon use
...
pub const PERRY_RUNTIME_VERSION: &str = env!("COOP_PERRY_RUNTIME_VERSION");

/// Exact Perry main revision accepted by this host.
pub const PERRY_RUNTIME_COMMIT: &str = env!("COOP_PERRY_RUNTIME_COMMIT");
...
pub use runtime_libraries::{
    ...
    CoopQueueEnqueueCallback, PerryProviderIdentity, ProviderVerification,
};
