...
impl ShardListener {
    ...
    pub async fn serve(self) -> Result<()> {
        ...
        for runtime in loaded {
            ...
            coop_app_host::queue_store::unregister_enqueue_context(runtime.deployment_context_id);
        }
        ...
        WorkerRequest::Hello(ClientHello {
            ...
            write_frame(
                ...
                &WorkerResponse::Hello {
                    ...
                    worker_name: format!("coop-worker-shard/{}", env!("CARGO_PKG_VERSION")),
...
async fn load_deployment(
    ...
    let result = async {
        ...
        .await
        {
            ...
            Err(error) => {
                if registered {
                    coop_app_host::queue_store::unregister_enqueue_context(context_id);
                }
...
mod tests {
    ...
    use coop_host_abi::WorkerDeploymentSpec;
