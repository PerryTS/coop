...
//!
//! Covers the subset of Bunny's API that Coop needs:
//!
...
impl BunnyClient {
    ...
    /// List all Pull Zones (paginated, but Coop will have few enough
    ...
    /// exists. Scans the full list (small for Coop — one zone per
...
mod tests {
    ...
    fn pull_zone_deserializes() {
        ...
        assert_eq!(zone.name, "coop-landing");
        assert_eq!(zone.hostnames.len(), 1);
        assert_eq!(zone.hostnames[0].value, "coop-landing.b-cdn.net");
    }
}
